          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("It's not you - it's us.", style: TextStyle(fontSize: 20, fontFamily: "metropolis", fontWeight: FontWeight.bold, color: Colors.black)),
                  SizedBox(
                    height: 40,
                  ),
                  ...
                  Text("6e4dd0a3-17da-487f-8a60-b41f6eea03be", style: TextStyle(fontSize: 12, fontFamily: "metropolis", fontWeight: FontWeight.w500, color: Colors.grey)),
                  SizedBox(
                    height: 40,
                  ),
                  ElevatedButton(
                    child: Text("Return to Event Page", style: TextStyle(fontSize: 16, fontFamily: "metropolis", fontWeight: FontWeight.normal, color: Colors.white)),
